 ...
 * @author     David Grudl
 */
class DatabasePanel extends Object implements IDebugPanel
{
	...
	{
		return '<span title="Database ' . htmlSpecialChars($this->name) . '">'
	...
	public function getPanel()
	{
		...
		foreach ($this->queries as $query) {
			...
			$s .= '<tr><td>' . sprintf('%0.3f', $time * 1000) . '</td><td class="database-sql">' . Connection::highlightSql(String::truncate($sql, self::$maxLength))
